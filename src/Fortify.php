...
class Fortify
{
     ...
     * @return void
     */
    public static function loginView($view): void
    {
     ...
     * @return void
     */
    public static function twoFactorChallengeView($view): void
    {
     ...
     * @return void
     */
    public static function resetPasswordView($view): void
    {
     ...
     * @return void
     */
    public static function verifyEmailView($view): void
    {
     ...
     * @return void
     */
    public static function confirmPasswordView($view): void
    {
     ...
     * @return void
     */
    public static function requestPasswordResetLinkView($view): void
    {
